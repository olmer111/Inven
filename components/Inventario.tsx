      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="h-11 w-full rounded-lg border border-zinc-300 bg-white pl-10 pr-3 text-sm text-zinc-900 placeholder:text-zinc-500 focus:border-emerald-600 focus:outline-none focus:ring-2 focus:ring-emerald-600/20"
          />
        </div>
        ...
        <div className="flex gap-2">
          {puedeExportarCSV(plan) && (
            <button
              ...
              className="flex h-11 items-center gap-2 rounded-full border border-zinc-300 px-4 text-sm font-medium text-zinc-700 transition duration-150 ease-out hover:bg-zinc-100 disabled:opacity-40 active:scale-[0.98]"
            >
      ...
      {cargando ? (
        <div className="space-y-3" aria-label="Cargando inventario">
          {[0, 1, 2].map((i) => (
            <div
              key={i}
              className="flex animate-pulse items-center gap-4 rounded-2xl border border-zinc-200 bg-white p-4"
            >
              <div className="h-14 w-14 rounded-lg bg-zinc-100" />
              <div className="flex-1 space-y-2">
                <div className="h-3.5 w-2/5 rounded bg-zinc-100" />
        ...
        <div className="flex flex-col items-center gap-3 rounded-2xl border border-dashed border-zinc-300 px-6 py-16 text-center">
